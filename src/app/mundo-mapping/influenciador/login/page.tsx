  ...
  return (
    <div className="flex flex-col items-center gap-3">
      ...
      <div className="text-center">
        ...
        <p className="text-xs font-semibold uppercase tracking-[0.18em] text-zinc-400">Área do Creator</p>
      </div>
    </div>
  );
}
...
export default function InfluenciadorLoginPage() {
  ...
  async function handleGoogle() {
    ...
    await supabase.auth.signInWithOAuth({
      provider: "google",
      options: { redirectTo: `${window.location.origin}/mundo-mapping/influenciador/dashboard` },
    });
  }
